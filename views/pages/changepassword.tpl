...
{block name="body"}
    ...
    <a href="index.php?p=favourite" class="btn btn-secondary">Favourite Songs</a>
    <a href="index.php?p=myrecipes" class="btn btn-secondary">My Playlists</a>
    <a href="index.php?p=add" class="btn btn-secondary">Add Playlist</a>
